...
class ViViT(pl.LightningModule):
    ...
    def forward(self, x, audio_feature=None):
        ...
        audio_feature = repeat(audio_feature, 'b f d -> b f p d', p=x.shape[2])
    ...
    def configure_optimizers(self):
        optimizer = torch.optim.Adam(self.parameters(), lr=1e-5, betas=(0.9, 0.999), eps=1e-08, weight_decay=0.0)
